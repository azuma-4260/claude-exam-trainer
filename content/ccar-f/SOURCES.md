...
| 2026-09-20 | flash 分割(オーナー指摘: 1 枚で複数の事実を答えさせる列挙型カードは 1 つの rating で評価できない): f-d2-q017(tool_choice 4 方式)/ f-d3-q001(CLAUDE.md 全スコープ)/ f-d3-q010(allowed-tools と argument-hint)/ f-d4-q023(Batches API 総まとめ)を retired、1 問 1 答に分割して f-d2-q038〜q040 / f-d3-q043〜q047 / f-d4-q041〜q042 を新規(active)。既存カードが単独で扱う事実(f-d2-q018 の tool 強制、f-d3-q002 の user スコープ、f-d3-q035 の disallowed-tools、f-d4-q024 / q025 / q038 の Batches 各論)は重複させず再収載しない。事実は不変なので syllabus / refs は変更なし |
